document.addEventListener("DOMContentLoaded", function() {
  ...
  let container = document.getElementById("disco-2");
  if (!container) {
    console.error("Container #disco-2 not found");
    return;
  }
  ...
  loader.load(
    "https://cdn.jsdelivr.net/gh/daveee00/export_blender/hor-disco1.glb", // <-- update this path if needed
    function (gltf) {
      model = gltf.scene;
